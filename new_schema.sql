...
--
-- Name: _sqlx_test; Type: SCHEMA; Schema: -; Owner: rue
--

CREATE SCHEMA _sqlx_test;


ALTER SCHEMA _sqlx_test OWNER TO rue;
...
--
-- Name: database_ids; Type: SEQUENCE; Schema: _sqlx_test; Owner: rue
--
...
ALTER SEQUENCE _sqlx_test.database_ids OWNER TO rue;
...
--
-- Name: databases; Type: TABLE; Schema: _sqlx_test; Owner: rue
--
...
ALTER TABLE _sqlx_test.databases OWNER TO rue;

--
-- Name: _sqlx_migrations; Type: TABLE; Schema: public; Owner: rue
--
...
ALTER TABLE public._sqlx_migrations OWNER TO rue;
...
--
-- Name: databases databases_pkey; Type: CONSTRAINT; Schema: _sqlx_test; Owner: rue
--
...
--
-- Name: _sqlx_migrations _sqlx_migrations_pkey; Type: CONSTRAINT; Schema: public; Owner: rue
--
...
--
-- Name: databases_created_at; Type: INDEX; Schema: _sqlx_test; Owner: rue
--
