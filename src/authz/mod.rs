...
//!
//! The decision logic is the shared `madar_authz` crate from madar-shared (the
//! POS core pins the same tag). This module loads grants from Postgres and adapts the
