...
#[openapi(
    ...
    tags(
        ...
        (name = "authz",        description = "Capabilities: what a person may do, roles, per-person access, explanations."),
        ...
        (name = "customers",    description = "Customers: list, history, addresses, create, edit, merge and PDPL erase."),
        (name = "order-now",    description = "Public: ordering from the wallet pass. The member token identifies; a device token for the customer's phone authorises."),
        ...
        (name = "push",         description = "Push-notification device registration (FCM), shared by every app; `app` names which one (e.g. `dawam`).")
    ),
paths(
        // ── ai analytics chat ────────────────────────────────────────
        ...
        crate::orgs::handlers::upload_org_card_image,
        ...
        crate::authz::api::create_role,
        crate::authz::api::rename_role,
        crate::authz::api::set_role_grant,
        crate::authz::api::delete_role,
        crate::authz::api::user_access,
        crate::authz::api::set_override,
        crate::authz::api::set_assignments,
        ...
        // ── menu modeling: bases, packaging rules, linked copies ─────
        crate::menu::bases::list_bases,
        crate::menu::bases::create_base,
        crate::menu::bases::get_base,
        crate::menu::bases::patch_base,
        crate::menu::bases::delete_base,
        crate::menu::bases::put_base_lines,
        crate::menu::bases::get_base_usage,
        crate::menu::bases::put_size_base,
        crate::menu::packaging::list_rules,
        crate::menu::packaging::create_rule,
        crate::menu::packaging::patch_rule,
        crate::menu::packaging::delete_rule,
        crate::menu::packaging::apply_rules,
        // ── combos and deals (COMBOS_CONTRACT.md, owner answers §11) ────
        crate::combos::handlers::list_combos,
        crate::combos::handlers::create_combo,
        crate::combos::handlers::get_combo,
        crate::combos::handlers::update_combo,
        crate::combos::handlers::combo_economics,
        crate::combos::handlers::put_meal,
        crate::combos::handlers::get_settings,
        crate::combos::handlers::put_settings,
        crate::combos::handlers::put_branch_channels,
        crate::combos::handlers::delete_branch_channels,
        crate::deals::handlers::list_deals,
        crate::deals::handlers::create_deal,
        crate::deals::handlers::update_deal,
        crate::deals::handlers::delete_deal,
        crate::deals::handlers::put_deal_branch,
        crate::deals::handlers::delete_deal_branch,
        crate::deals::public::branch_cart_quote,
        crate::deals::public::table_cart_quote,
        crate::reports::bundles::bundles_report,
        crate::reports::bundles::combo_mix,
        ...
        crate::customers::handlers::list_customer_addresses,
        crate::customers::order_now::context,
        crate::customers::order_now::replace_identity,
        crate::customers::order_now::combine,
        ...
        crate::staff_pool::record::summary,
        crate::loyalty::settings::delete_settings,
        crate::loyalty::settings::get_reward_items,
        crate::loyalty::settings::put_reward_items,
        crate::loyalty::settings::get_earning_items,
        crate::loyalty::settings::put_earning_items,
        crate::loyalty::handlers::lookup,
        crate::loyalty::award::award,
        crate::loyalty::handlers::adjust,
        crate::loyalty::handlers::wallet_status,
        crate::loyalty::handlers::google_object,
        crate::loyalty::handlers::google_refresh,
        crate::loyalty::handlers::birthday_preview,
        crate::loyalty::handlers::list_members,
        crate::loyalty::handlers::get_member,
        crate::loyalty::handlers::delete_member,
        crate::loyalty::handlers::analytics,
        crate::loyalty::handlers::behavior,
        crate::loyalty::handlers::campaign_effectiveness,
        crate::loyalty::handlers::liability_trend,
        crate::loyalty::public::join_info,
        crate::loyalty::public::join,
        crate::orgs::public::brand,
        crate::orgs::public::favicon,
        crate::orgs::links_page::public_links,
        ...
        crate::staff::schedules::put_day,
        crate::staff::schedules::reset_day,
        crate::staff::schedules::put_times,
        crate::staff::schedules::move_shift,
        // ── staff: attendance ─────────────────────────────────────────
        crate::staff::attendance::get_attendance_settings,
        crate::staff::attendance::put_attendance_settings,
        crate::staff::attendance::list_branch_rules,
        crate::staff::attendance::delete_branch_rules,
        crate::staff::attendance::list_attendance,
        crate::staff::attendance::attendance_summary,
        crate::staff::discipline::discipline_report,
        ...
        crate::staff::payroll::unwaive_deduction,
        crate::staff::payroll::list_audit,
        ...
        crate::staff::dawam::presence::open_cover,
        crate::staff::dawam::presence::decide_cover,
        crate::staff::dawam::presence::decide_overtime,
        crate::staff::dawam::presence::punch_for,
        crate::staff::dawam::presence::till_punch,
        crate::staff::dawam::presence::revoke_device,
        crate::staff::dawam::roster::roster,
        crate::staff::dawam::roster::my_roster,
        ...
        crate::staff::dawam::roster::list_swaps,
        crate::staff::dawam::roster::list_open_shifts,
        crate::staff::dawam::roster::decide_swap,
        crate::staff::dawam::roster::put_preferences,
        crate::staff::dawam::roster::decide_holiday,
        crate::staff::dawam::roster::suggestions,
        crate::staff::dawam::roster::decide_suggestion,
        crate::staff::dawam::roster::get_coverage,
        crate::staff::dawam::roster::put_coverage,
        crate::staff::dawam::roster::fairness,
        crate::staff::dawam::roster::cancel_open_shift,
        crate::staff::dawam::roster::cancel_swap,
        crate::staff::dawam::roster::put_employee_preferences,
        crate::staff::dawam::roster::preference_log,
        crate::staff::dawam::suggest::fairness_audits,
        crate::staff::dawam::reports::labour_vs_sales,
        crate::staff::dawam::reports::payroll_history,
        crate::staff::dawam::reports::advances,
        crate::staff::dawam::pay::current,
        crate::staff::dawam::pay::my_estimate,
        crate::staff::dawam::pay::mark_paid,
        crate::staff::dawam::pay::create_adjustment,
        crate::staff::dawam::pay::list_adjustments,
        crate::staff::dawam::pay::my_adjustments,
        crate::staff::dawam::pay::decide_adjustment,
        crate::staff::dawam::pay::stop_adjustment,
        crate::staff::dawam::pay::review_advance,
        ...
        // ── push ─────────────────────────────────────────────────────
        crate::push::handlers::set_push_token,
        crate::push::handlers::delete_push_token,
        // ── stocktakes ────────────────────────────────────────────────
        ...
        crate::reports::handlers::branch_sales_peak_days,
        ...
        crate::reports::legal::refunds_audit,
        crate::reports::legal::voids_audit,
        crate::reports::legal::discounts_audit,
        crate::reports::legal::waivers_audit,
        crate::reports::legal::price_overrides,
        crate::reports::legal::manual_deductions_audit,
        crate::reports::legal::deduction_overrides_audit,
        crate::reports::legal::loyalty_adjustments_audit,
        crate::reports::legal::attendance_corrections_audit,
        ...
        crate::reports::handlers::branch_channel_breakdown,
        crate::reports::handlers::branch_supplier_spend,
        crate::reports::handlers::org_supplier_spend,
        crate::reports::handlers::branch_po_lead_time,
        crate::reports::handlers::org_po_lead_time,
        crate::reports::handlers::branch_material_cost_trend,
        crate::reports::handlers::org_material_cost_trend,
        // ── payment_methods ───────────────────────────────────────────
    ...
    components(schemas(
        ...
        crate::staff_pool::record::StaffDrinksSummary,
        crate::staff_pool::order_line::StaffDrinkLine,
        crate::loyalty::settings::RewardItem,
        crate::loyalty::settings::RewardCatalogue,
        crate::loyalty::settings::EarningItem,
        crate::loyalty::settings::EarningItemList,
        crate::loyalty::settings::PutEarningItems,
        crate::loyalty::model::MemberView,
        crate::loyalty::handlers::WalletStatus,
        crate::loyalty::handlers::GoogleObjectDump,
        crate::loyalty::handlers::GoogleRefreshReport,
        crate::loyalty::wallet::google::WalletStep,
        crate::loyalty::handlers::WalletProvider,
        crate::loyalty::handlers::BirthdayPreview,
        crate::loyalty::award::AwardResult,
        crate::loyalty::model::LedgerEntry,
        crate::loyalty::handlers::LoyaltyAnalytics,
        crate::loyalty::handlers::TopReward,
        crate::loyalty::handlers::PointsLiability,
        ...
        crate::staff::attendance::BranchRules,
        ...
        crate::staff::payroll::PayrollTotals,
        crate::staff::payroll::AuditRow,
