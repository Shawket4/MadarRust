use actix_web::web;
use crate::{auth::middleware::JwtMiddleware, branches::handlers, qr_card::handlers as qr_handlers};
...
pub fn configure(cfg: &mut web::ServiceConfig) {
    cfg.service(
        web::scope("/branches")
            ...
            .route("/{id}/tables/{tid}",     web::delete().to(qr_handlers::delete_table))
            .route("/{id}/tables/{tid}/qr",  web::get().to(qr_handlers::table_qr)),
    );
