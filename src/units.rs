...
mod tests {
    ...
    fn density_bridges_mass_and_volume() {
        ...
        assert_eq!(convert_with_density(250.0, "ml", "g", Some(1.0)).unwrap(), 250.0);
        // oil 0.92 g/ml: 1 l → 920 g; and the reverse.
        assert_eq!(convert_with_density(1.0, "l", "g", Some(0.92)).unwrap(), 920.0);
        assert_eq!(convert_with_density(920.0, "g", "ml", Some(0.92)).unwrap(), 1000.0);
    ...
    fn convert_with_density_divides_by_target_factor() {
        ...
        assert_eq!(convert_with_density(1000.0, "ml", "kg", Some(1.0)).unwrap(), 1.0);
    }
    ...
    fn normalize_to_base_returns_base_unit_and_converted_qty() {
        ...
        assert_eq!(normalize_to_base(1.0, "kg", "g").unwrap(), ("g".to_string(), 1000.0));
        assert_eq!(normalize_to_base(250.0, "g", "kg").unwrap(), ("kg".to_string(), 0.25));
